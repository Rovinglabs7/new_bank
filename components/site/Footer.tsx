...
const NAV_COLUMNS = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Partner Integrations", href: "/integrations" },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Ambassador Programme", href: "/partners/ambassadors" },
      { label: "Technology Partners", href: "/partners/technology" },
      { label: "Accounting Integrations", href: "/partners/accounting" },
      { label: "Banking Partners", href: "/partners/banking" },
      { label: "Referral Programme", href: "/partners/referral" },
    ],
  },
  {
    heading: "Legal",
      ...
      <div className={styles.inner}>
        ...
        <div className={styles.mainGrid}>
          ...
          <div className={styles.brandCol}>
            ...
            <p className={styles.builtWith}>Built with love from London.</p>
          </div>
